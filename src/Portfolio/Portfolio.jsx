...
const Portfolio = () => {
  ...
  return (
    <div className="bg-[#050505] text-white selection:bg-[#6366F1]/30 cursor-none overflow-x-hidden font-sans">
      ...
      <div
        ref={followerRef}
        className="fixed top-0 left-0 w-10 h-10 border border-[#6366F1]/50 rounded-full pointer-events-none z-[9998] -translate-x-1/2 -translate-y-1/2 flex items-center justify-center"
      ></div>
